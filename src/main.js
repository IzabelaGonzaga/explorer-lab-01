...
//query selector é o mesmo do css
...
//ano: intervalo de 10 anos do ano atual
...
function updateExpirationDate(date) {
  ...
  ccExpiration.innerHTML = date.length > 0 ? date : "02/32"
}
...
function updateCardNumber(number) {
  const cardNumber = document.querySelector(".cc-info .cc-number")
  cardNumber.innerText = number.length > 0 ? number : "1234 5678 9012 3456"
}
